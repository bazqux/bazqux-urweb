...
// ^ в VHDL есть какая-то ф-я, которая заменяет window.bq, причем только
//   в iOS? на desktop все работает
...
hljs.configure({classPrefix: 'hljs-', languages:["xml", "cpp", "haskell", "bash", "java", "fsharp", "objectivec", "ini", "php", "sql", "lisp", "erlang", "makefile", "perl", "ruby", "apache", "json", "clojure", "css", "nginx", "csharp", "javascript", "lua", "scheme", "ocaml", "python", "go"]});
