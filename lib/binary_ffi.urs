con putBuf :: Type
con xbodyString :: Type
type xhead = xml head [] []

val mkPutBuf : {} -> putBuf
val putBufString : putBuf -> string
val put_byte   : putBuf -> int -> putBuf
...
val put_xbodyString : putBuf -> xbodyString -> putBuf
...
val get_xbodyString_ : getBuf -> xbodyString
